import 'package:flutter_demo/config/share-preference-tags.dart';
...
class GalleryRequest {
  static getAllPaintings () async{
    ...
    String lastUpdateTimes = sp.getString(SharePreferenceTags.lastUpdateGallery);
    if (lastUpdateTimes == null) lastUpdateTimes = "2018-03-20T11:01:01.801Z";
    return FetchClient.get('/templates',{
        "updated_after":lastUpdateTimes,
        "is_official": "true"
    });
  }
}
